        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ $route }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <x-forms.input label="Brand Name" name="name" value="{{ isset($formValue) ? $formValue->name : ''  }}" />
                        </div>
                        <div class="col-7">
                            <x-forms.input label="Short Description (max: 100)" name="description" value="{{ isset($formValue) ? $formValue->description : ''  }}" />
                        </div>
                        <div class="col-2 ">
                            <button type="submit" class=" btn btn-primary mt-30 w-100 ">{{ isset($btn) ? $btn : 'Create Brand'}}</button>
                        </div>
                    </div>
                </form>
            </div>
